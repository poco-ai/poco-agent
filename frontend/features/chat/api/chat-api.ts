...
function toExecutionSession(
  ...
  return {
    ...
    workspace_files_prefix: session.workspace_files_prefix ?? null,
    workspace_manifest_key: session.workspace_manifest_key ?? null,
    workspace_archive_key: session.workspace_archive_key ?? null,
    task_name: undefined,
